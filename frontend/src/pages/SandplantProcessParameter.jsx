          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
            ...
            <div>
              <h4 style={{ fontWeight: '600', color: '#1e3a8a', margin: '0 0 0.5rem 0', fontSize: '0.875rem' }}>
                Sandplant Guidelines
              </h4>
              <ul style={{ fontSize: '0.875rem', color: '#1e40af', margin: 0, paddingLeft: '1.25rem', lineHeight: '1.5' }}>
                <li>Maintain consistent moisture content for optimal mold quality</li>
                <li>Monitor sand properties to ensure proper mold characteristics</li>
                <li>Record mixing parameters for process optimization</li>
                <li>Follow standard testing procedures for sand quality control</li>
              </ul>
            </div>
          </div>
        </div>
