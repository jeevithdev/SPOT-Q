          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: '0.75rem' }}>
            ...
            <div>
              <h4 style={{ fontWeight: '600', color: '#1e3a8a', margin: '0 0 0.5rem 0', fontSize: '0.875rem' }}>
                Metallography Guidelines
              </h4>
              <ul style={{ fontSize: '0.875rem', color: '#1e40af', margin: 0, paddingLeft: '1.25rem', lineHeight: '1.5' }}>
                <li>Follow standard metallographic preparation procedures</li>
                <li>Use consistent magnification and lighting conditions</li>
                <li>Record detailed observations for quality traceability</li>
                <li>Maintain proper specimen handling and storage</li>
              </ul>
            </div>
          </div>
        </div>
