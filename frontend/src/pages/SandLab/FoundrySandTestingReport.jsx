...
import { Filter, Loader2, FileText, RefreshCw } from 'lucide-react';
...
const FoundrySandTestingReport = () => {
  ...
  const handleBackToEntry = () => {
    navigate('/sand-lab/foundry-sand-testing-note');
  };
      ...
      <div className="foundry-report-content">
        ...
        <div className="foundry-report-header">
          <div className="foundry-report-header-text">
            <h2>
              <Filter size={28} style={{ color: '#5B9AA9' }} />
              Foundry Sand Testing Note - Reports
              <button 
                className="foundry-report-view-entry-btn"
                onClick={handleBackToEntry}
                title="Back to Entry Form"
              >
                <FileText size={14} />
          ...
          <div className="foundry-report-header-buttons">
            <button 
              className="foundry-report-reset-btn"
